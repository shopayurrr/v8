...
var siteContent2 = pgTable("site_content", {
  id: serial("id").primaryKey(),
...
var insertSiteContentSchema = createInsertSchema(siteContent2).pick({
  key: true,
  value: true,
  description: true
});
...
async function registerRoutes(app2) {
  ...
  app2.patch("/api/admin/users/:userId", requireAdmin, async (req, res) => {
    try {
      ...
      if (occupation !== void 0) updateData.occupation = occupation;
      ...
      if (transactions !== void 0) updateData.transactions = transactions;
