        ...
        <Dialog open={isAddingUser} onOpenChange={setIsAddingUser}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid gap-6 py-4">
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <Input id="new-occupation" value={newUser.occupation} onChange={(e) => setNewUser({...newUser, occupation: e.target.value})} />
                  </div>
                </div>
              </section>
              ...
              <section className="space-y-4">
                <h3 className="font-semibold border-b pb-2">Recent Transactions (JSON format)</h3>
                <div className="space-y-2">
                  <textarea 
                    id="new-transactions" 
                    className="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    value={newUser.transactions} 
                    onChange={(e) => setNewUser({...newUser, transactions: e.target.value})} 
                    placeholder="[]"
                  />
                </div>
              </section>
